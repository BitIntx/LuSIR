...
complete, the bounded masked detail v3 perceptual/adversarial probe is
implemented but not yet trained, Stage 2 clean-fidelity learning-rate
probes are complete, and signed-wavelet residual diffusion was evaluated
and rejected as the current generative-detail objective.
