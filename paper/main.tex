...
The next detail experiment should retain the frozen fidelity base and
learned mask, but avoid the current PatchGAN objective. Candidate
directions are explicit artifact/noise-negative generator loss inside
the mask, a smaller fixed-review patch objective, or a Stage-1
decoder-side detail-capacity audit.
