...
and the follow-up Stage 2 latent residual adapter are now complete;
neither is promoted.
...
\begin{itemize}
\item
  review the masked latent residual-shift v2 fidelity continuation. The
  ...
  visible effect. The active v2 continuation therefore reduces
  latent-target weight from 1.0 to 0.1 and strengthens decoded image,
  high-frequency, outside-mask, and lowpass supervision. It is evaluated
  from timestep 10 and must improve high-frequency error without
