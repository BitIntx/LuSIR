...
together. Mean PSNR increases from \texttt{26.91987} to
\texttt{27.00503\ dB}, SSIM from \texttt{0.82145} to \texttt{0.82422},
while highpass ratio remains effectively unchanged (\texttt{0.82463} to
\texttt{0.82375}). Highpass L1, missing energy, and excess energy all
decrease slightly. The fixed grid shows no obvious smoothing, ripple
pattern, or oversharpening. This is an interim result; the run continues
and is not yet promoted.
