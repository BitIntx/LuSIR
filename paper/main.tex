...
Stage 2 latent residual adapter, and masked latent residual-shift probes
are complete; none is promoted. The active follow-up is a
teacher-filtered v7 detail probe that uses RealESRGAN only on local
highpass patches that are near/better than the base against GT.
...
\NormalTok{active teacher{-}filtered probe:}
\NormalTok{  LR {-}\textgreater{} dual{-}context LSDIR Stage 2 {-}\textgreater{} Stage 1 decoder}
