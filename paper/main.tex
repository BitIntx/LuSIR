...
learning-rate probes complete, and signed-wavelet residual diffusion
evaluated and rejected as the current generative-detail objective.
...
\item
  ...
  separate learned detail-need mask before applying stochastic texture
  synthesis;
\item
