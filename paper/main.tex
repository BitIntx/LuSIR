...
\item
  audit Stage 1 decoder-side detail capacity, because Stage 2
  improvements can still decode into overly smooth images if the VAE
  decoder is the limiting reconstruction component;
\item
