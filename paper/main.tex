...
conditional-latent smoothing. The current active visible-detail probe is
a no-GAN, noise-gated v6 detail branch that keeps the frozen fidelity
path and adds filtered teacher/highpass and artifact-negative residual
supervision.
...
\NormalTok{  LR {-}\textgreater{} dual{-}context LSDIR Stage 2 {-}\textgreater{} Stage 1 decoder}
\NormalTok{     {-}\textgreater{} v2 noise{-}negative top10 detail mask {-}\textgreater{} no{-}GAN v6 detail branch}
