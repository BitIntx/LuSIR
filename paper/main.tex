...
ratio, and \texttt{0.01971} to \texttt{0.01314} missing-detail energy,
so the active bottleneck is now better framed as generalizing the
detail-preserving signal rather than proving basic representational
capacity.
