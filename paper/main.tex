...
high-frequency detail once generalization is removed.
...
\item
  ...
  as a non-deployable upper-bound check. Its smoke baseline on train64
  is \texttt{26.42} mean PSNR, \texttt{0.791} highpass ratio, and
  \texttt{0.01971} missing energy. If this fixed-set run cannot improve
  highpass ratio and missing energy, dataset scale or longer
  continuation is unlikely to solve the active smoothing bottleneck by
  itself;
\item
